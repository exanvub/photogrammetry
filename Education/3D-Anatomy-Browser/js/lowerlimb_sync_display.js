...
const { scene: scene1, camera: camera1, renderer: renderer1, controls: controls1 } = loadModel('models/lowerlimb_diffuse/scene.gltf', canvas1, 0.8, 0.8); //zoomFactor, ambientLightIntensity
const { scene: scene2, camera: camera2, renderer: renderer2, controls: controls2 } = loadModel('models/lowerlimb_polarized/scene.gltf', canvas2, 0.9, 1.5); //zoomFactor, ambientLightIntensity
