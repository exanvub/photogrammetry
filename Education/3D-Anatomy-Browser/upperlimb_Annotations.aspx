  ...
  <body>
    ...
    <main>
      ...
      <select id="model-select">
        <optgroup label="Choose a model"></optgroup>
        <option value="Upperlimb_polarized_Annotations">Annotations (polarized)</option>
        <option value="Upperlimb_diffuse_Annotations">Annotations (Diffuse lighting)</option>
      ...
      <div id="info"></div> <!-- Element to show 'text' -->
