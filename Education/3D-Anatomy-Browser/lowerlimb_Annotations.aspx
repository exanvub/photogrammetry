  ...
  <body>
    ...
    <main>
      ...
      <select id="model-select">
        ...
        <option value="lowerlimb_polarized_Annotations">Annotations (polarized)</option>
        <option value="lowerlimb_diffuse_Annotations">Annotations (Diffuse lighting)</option>
